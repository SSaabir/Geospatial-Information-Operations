...
const ClimateHomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50" style={{backgroundColor: '#F5EFFF'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: '#A294F9'}}>
                <Cloud className="w-6 h-6 text-white" />
              </div>
              <div>
                <h1 className="text-xl font-bold text-gray-800">Climate Data Explorer</h1>
                <p className="text-sm text-gray-600">Sri Lanka Weather Analytics</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
              <button className="px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2" style={{backgroundColor: '#A294F9'}}>
                <MessageSquare className="w-5 h-5" />
                <span>Chat with AI</span>
              </button>
              <button className="px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl border-2 flex items-center space-x-2" style={{borderColor: '#CDC1FF', color: '#6B46C1', backgroundColor: 'white'}}>
      ...
      {/* Footer */}
      <footer className="py-12 px-4" style={{backgroundColor: '#A294F9'}}>
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-6 md:mb-0">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                <Cloud className="w-5 h-5" style={{color: '#A294F9'}} />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white">Climate Data Explorer</h3>
                <p className="text-purple-100 text-sm">Sri Lanka Weather Analytics Platform</p>
              </div>
            </div>
          ...
          <div className="border-t border-purple-300 mt-8 pt-8 text-center text-purple-100">
            <p>&copy; 2024 Climate Data Explorer. All rights reserved. | Powered by AI & Weather Analytics</p>
          </div>
        </div>
      </footer>
